...
namespace LiabraryMnagementS.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DateOfBirth,Country,Province")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DateOfBirth,Country,Province")] Author author)
        {
            if (id != author.Id)
            {
                return NotFound();
