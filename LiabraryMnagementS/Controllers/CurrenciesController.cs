...
namespace LiabraryMnagementS.Controllers
{
    public class CurrenciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Abbreviations")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Abbreviations")] Currency currency)
        {
            if (id != currency.Id)
            {
                return NotFound();
