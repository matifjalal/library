...
namespace LiabraryMnagementS.Controllers
{
    public class BooksCatagoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Cost")] BooksCatagory booksCatagory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Cost")] BooksCatagory booksCatagory)
        {
